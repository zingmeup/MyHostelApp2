...
function getArgs(){
	$argsMissing=false;
		if (isset($_POST['user_id'])&&!empty($_POST['user_id'])&&isset($_POST['access_token'])&&!empty($_POST['access_token'])&&isset($_POST['place'])&&!empty($_POST['place'])&&isset($_POST['purpose'])&&!empty($_POST['purpose'])&&isset($_POST['going_with'])&&!empty($_POST['going_with'])&&isset($_POST['phone'])&&!empty($_POST['phone'])&&isset($_POST['parent_no'])&&!empty($_POST['parent_no'])&&isset($_POST['date_exp_out'])&&!empty($_POST['date_exp_out'])&&isset($_POST['date_exp_in'])&&!empty($_POST['date_exp_in'])&&isset($_POST['time_exp_out'])&&!empty($_POST['time_exp_out'])) {
